...
7. Нажимаем на значок `+` рядом с названием USB. Если вы ничего не трогали в настройках, то у вас появится два раздела, один из которых будет иметь название `CLOVER`, а другой `NONAME`.
...
Теперь у вас есть готовая USB с образом **macOS**. Но это только начало. 
